...
def main():
    st.title("Presidential Speeches Q&A")
    st.write("""
    Welcome! Ask a question about U.S. presidents, like "What were George Washington's views on democracy?" or "What did Abraham Lincoln say about national unity?".
    The app will retrieve relevant excerpts from presidential speeches and generate a response.
    """)
